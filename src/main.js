    ...
    <section id="leadership" class="section leadership-section">
      <div class="container">
        ...
        <div class="partners-grid-detailed">
           ...
           <div class="glass partner-card-premium">
             <div class="partner-logo-large-container">
               <img src="/assets/leadership/lisk.png" alt="Lisk" class="partner-logo-large" style="max-height: 45px;">
             </div>
             <div class="partner-role-text">Premium Partner</div>
             <h3 class="partner-name-premium">Lisk</h3>
             <p class="partner-desc-premium">
               An open-source Ethereum Layer 2 (L2) ecosystem built on the Optimism (OP) Stack. 
               Focuses on providing a full-stack growth platform for Web3 founders in high-growth emerging markets like Africa, Southeast Asia, and Latin America.
             </p>
             <div class="partner-links-premium">
               <a href="https://lisk.com" target="_blank" aria-label="Website">
                 <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="2" y1="12" x2="22" y2="12"></line><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path></svg>
               </a>
               <a href="https://x.com/LiskHQ" target="_blank" aria-label="Twitter">
                 <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
               </a>
